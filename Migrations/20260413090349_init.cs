        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkingHours = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    LastUpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RiderStats", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalProviders_ExpiresAt",
                table: "ExternalProviders",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_ExternalProviders_Username",
                table: "ExternalProviders",
                column: "Username",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RiderStats_CompanyId_Date",
                table: "RiderStats",
                columns: new[] { "CompanyId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_RiderStats_Date",
                table: "RiderStats",
                column: "Date");

            migrationBuilder.CreateIndex(
                name: "IX_RiderStats_RiderId_RiderName_Date_CompanyId",
                table: "RiderStats",
                columns: new[] { "RiderId", "RiderName", "Date", "CompanyId" },
                unique: true);
        }
